...
const PLANS: Record<string, { label: string; price: string; role: string }> = {
  pro: { label: "SmartLink Pro", price: "$6.99", role: "premium_user" },
  enterprise: { label: "SmartLink Enterprise", price: "$12.99", role: "enterprise_user" },
};
