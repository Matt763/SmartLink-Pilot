...
const sections = [
  ...
  { id: "subscriptions", title: "5. Subscriptions, Billing & Advertising", content: "Premium subscriptions (Pro and Enterprise) are billed monthly via Pesapal, which supports credit/debit cards and mobile money (M-Pesa, Airtel Money, and others). By subscribing, you authorize us to charge your payment method on a recurring basis. Subscriptions auto-renew until cancelled. You may cancel at any time through your account settings; access continues until the end of the current billing period. No partial refunds are issued for unused time within a billing period, except where required by law. We offer a 14-day money-back guarantee for first-time subscribers. Price changes take effect at the start of the next billing cycle with 30 days advance notice. Free accounts are supported by advertising: Google AdSense advertisements may be displayed to free-tier users. Upgrading to a Pro or Enterprise plan removes all advertisements from your experience immediately." },
  ...
  { id: "privacy", title: "7. Privacy, Data & Visitor Analytics", content: "Your use of the Service is subject to our Privacy Policy, which is incorporated into these Terms by reference. We are committed to handling your data with transparency and care. By using our Service, you consent to the data practices described in our Privacy Policy, including: the collection of anonymous visitor session data (device type, browser, country, referrer, pages visited, and time spent) for internal platform analytics; the collection of link click analytics for your reporting dashboard; and the display of Google AdSense advertisements to free-tier users. Visitor analytics are stored against a random session ID containing no personally identifiable information. Paid subscribers are exempt from advertising and their data is handled identically to free users in all other respects." },
  ...
  { id: "contact", title: "13. Contact", content: "For questions about these Terms, contact us at legal@smartlinkpilot.com. Our registered office: Mayobe Bros, Arusha, Tanzania. This document was last updated on April 2, 2026." },
];
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      <div className="bg-gradient-to-br from-blue-600 to-purple-700 dark:from-blue-800 dark:to-purple-900 py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-blue-100 mb-2">Last updated: April 2, 2026 · Effective: April 2, 2026</p>
